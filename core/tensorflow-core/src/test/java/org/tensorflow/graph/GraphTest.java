...
public class GraphTest {
  ...
  public void addGradientsToGraph() {
    try (Graph g = new Graph();
      ...
      Output<TFloat> x1 = TestUtil.placeholder(g, "x1", Float.class);
      Output<TFloat> x2 = TestUtil.placeholder(g, "x2", Float.class);
      ...
      assertSame(TFloat.TYPE, grads0[0].dataType());

      Output<?>[] grads1 = g.addGradients(y2, toArray(x1, x2));
      assertNotNull(grads1);
      assertEquals(2, grads1.length);
      assertSame(TFloat.TYPE, grads1[0].dataType());
      assertSame(TFloat.TYPE, grads1[1].dataType());
  ...
  public void addGradientSumsToGraph() {
    try (Graph g = new Graph();
      ...
      Output<TFloat> x = TestUtil.placeholder(g, "x", Float.class);
      ...
      assertSame(TFloat.TYPE, grad[0].dataType());
  ...
  public void buildWhileLoopSingleInput() {
    try (Graph g = new Graph();
      ...
      try (Tensor<Int32> c = Tensors.create(2);
  ...
  public void buildWhileLoopMultipleInputs() {
    try (Graph g = new Graph();
      ...
      try (Tensor<Int32> c1 = Tensors.create(2);
          Tensor<Int32> c2 = Tensors.create(5);
