...
public class GraphOperationTest {
  ...
  public void outputEquality() {
    try (Graph g = new Graph()) {
      Output<Int32> output = TestUtil.constant(g, "c", 1);
      Output<Int32> output1 = output.op().output(0);
      Output<Int32> output2 = g.operation("c").output(0);
  ...
  public void outputCollection() {
    try (Graph g = new Graph()) {
      ...
      Output<Int32> output1 = output.op().output(0);
      Output<Int32> output2 = g.operation("c").output(0);
      Set<Output<Int32>> ops = new HashSet<>();
  ...
  public void outputToString() {
    try (Graph g = new Graph()) {
      Output<Int32> output = TestUtil.constant(g, "c", new int[] {1});
